...
-   **Significance:** The coefficient for total_goal_contributions is statistically significant (p-value = 0.0148), meaning that it does have a significant effect on log salary.
